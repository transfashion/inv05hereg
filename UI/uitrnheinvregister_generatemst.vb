...
Public Class uitrnheinvregister_generatemst
...
#Region " Background Worker - Generate Data"
    ...
    Private Sub bgwGenerate_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bgwGenerate.DoWork
        ...
        Try
            ...
            service = CreateWebService(Me.WebserviceNSModule, Me.WebserviceObjectModule, "generate")
...
#End Region
    ...
    Private Sub btnGenerate_Clicked(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        ' Cek dulu
        If Me.obj_heinvregister_type.SelectedValue <> "O" Then
            ' Selain order confirmation, proses generate hanya dilakukan apabila TM sudah ada isinya
            For Each row As DataGridViewRow In Me.DgvDetilItem.Rows
                Dim line As Integer = row.Cells("heinvregisteritem_line").Value
                Dim heinv_id As String = row.Cells("heinv_id").Value
                If heinv_id = "" Then
                    MessageBox.Show("id untuk item di line " & line & " masih belum terisi." & vbCrLf & "Generate barang baru hanya bisa dilakukan di register intuk Order Confirmation!", "Generate", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                    Exit Sub
                End If
            Next
        End If
